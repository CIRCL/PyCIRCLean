...
class Config:
    ...
    malicious_exts = (
        ...
        ".7z", ".ace", ".arc", ".arj", ".b64", ".balz", ".bhx", ".bz", ".bz2",
        ".bzip2", ".cab", ".cpio", ".fat", ".gz", ".gzip", ".hfs", ".hqx", ".iso",
        ".lha", ".lpaq1", ".lpaq5", ".lpaq8", ".lzh", ".lzma", ".mim", ".ntfs",
        ".paq8f", ".paq8jd", ".paq8l", ".paq8o", ".pea", ".quad", ".r00", ".r01",
        ".r02", ".r03", ".r04", ".r05", ".r06", ".r07", ".r08", ".r09", ".r10",
        ".r11", ".r12", ".r13", ".r14", ".r15", ".r16", ".r17", ".r18", ".r19",
        ".r20", ".r21", ".r22", ".r23", ".r24", ".r25", ".r26", ".r27", ".r28",
        ".r29", ".rar", ".squashfs", ".swm", ".tar", ".taz", ".tbz", ".tbz2",
        ".tgz", ".tpz", ".txz", ".tz", ".udf", ".uu", ".uue", ".vhd", ".vmdk",
        ".wim", ".wrc", ".xar", ".xxe", ".xz", ".z", ".zip", ".zipx", ".zpaq",
        ".cdr", ".dart", ".dc42", ".diskcopy42", ".dmg", ".dmgpart", ".dvdr",
        ".img", ".imgpart", ".ndif", ".smi", ".sparsebundle", ".sparseimage",
        ".toast", ".udif",
    )
